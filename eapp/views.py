...
def reject_purchase_order(request, purchase_order_id):
 ...
 # Redirect to seller purchase orders page
...
from .serializers import CustomerSerializer, SellerSerializer, ProductSerializer, CategorySerializer, SubcategorySerializer, CartSerializer, OrderSerializer, OrderItemSerializer, PurchaseOrderSerializer, PurchaseOrderItemSerializer, AddressSerializer
